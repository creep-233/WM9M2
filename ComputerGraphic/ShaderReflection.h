...
public:
	...
	//void build(DXCore* core, ID3DBlob* shader, std::vector<ConstantBuffer>& buffers, std::map<std::string, int>& textureBindPoints, ShaderStage shaderStage, ID3D11Device* device);
